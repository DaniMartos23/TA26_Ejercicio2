...
--
-- Host: 192.168.1.137    Database: ta26_ej2
-- ------------------------------------------------------
...
CREATE TABLE `asignado_a` (
  ...
  CONSTRAINT `asignado_a_ibfk_2` FOREIGN KEY (`proyecto`) REFERENCES `proyectos` (`id`)
...
INSERT INTO `asignado_a` VALUES (1,'49117196','PO01'),(2,'48117195','PO02'),(3,'47117194','PO03'),(4,'47117194','PO01');
...
-- Dump completed on 2022-11-21 22:45:54
